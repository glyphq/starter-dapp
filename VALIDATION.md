...
| Static production output remains valid       | `bun run test && bun run build`                                                                                       | TypeScript and lint pass. The isolated suite passes 66 tests with 314 expectations. Next.js produces static `/` and `/_not-found` routes.                                                           |
